...
urlpatterns = patterns('',
    ...
    url(r'^rsync_state_dropdown/', rsync_state_dropdown),
    ...
    url(r'^salt_top/', salt_top),
    url(r'^salt_top_data/', salt_top_data),
    url(r'^salt_top_save/', salt_top_save),
    url(r'^salt_top_dropdown/', salt_top_dropdown),
    url(r'^salt_top_del/', salt_top_del),
    url(r'^salt_top_run/', salt_top_run),
