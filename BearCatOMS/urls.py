...
from operation.views import upload,get_upload,upload_data,upload_del,upload_upload,server_operation,password_expire,get_server_list,\
    search_server_list,run_cmd,server_del,server_group,server_group_data,server_group_dropdown,server_group_save,server_group_del,\
    rsync_dest_dropdown,fortress_server
